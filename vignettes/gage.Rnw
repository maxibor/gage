...
\\
\\
Another new function, \Rfunction{go.gsets}, has been introduced in the package. You may use it to compile GO (Gene Ontology) gene set data any time needed for 19 common species annotated in Bioconductor and more others by the users. Please check the help info on the function for details.
...
#save(go.bp, go.mf, go.cc, file="go.gsets.RData")
@
