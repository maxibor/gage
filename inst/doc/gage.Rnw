...
We load and look at the demo microarray data first. Note that although we use microarray data as example, GAGE is equally applicable to RNA-Seq data and other types of gene/protein centered high throughput data.
<<dataPrep, echo=TRUE>>=
data(gse16873)
...
\begin{figure}
        ...
        \begin{subfigure}[b]{1.0\textwidth}
                \centering
                \fbox{\includegraphics[width=15cm,type=png,ext=.png,read=.png]{hsa00020.pathview.DCIS_1}}
                \caption{}
                \label{fig:4a}
        \end{subfigure}
        \\
        ...
        \begin{subfigure}[b]{1.0\textwidth}
                \centering
                \includegraphics[width=15cm,type=pdf,ext=.pdf,read=.pdf]{hsa04110.pathview.DCIS_1}
                \caption{}
                \label{fig:4b}
        \end{subfigure}
        \\
